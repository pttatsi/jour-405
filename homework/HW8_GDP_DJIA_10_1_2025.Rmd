...
gdp_data |> 
 ...
 labs(title = "Measure of US Economic Activity", x = " Dow Jones Industrial Average", y = "Gross Domestic Product")
```
...
There is a positive correlation between the DJIA and GDP, the move in tandem to one another. Visually, it looks like they used to be more tightly related in the mid-2010s and have spread further apart since then. This might be due to factors  such as inflation that distorts the relationship of the two varibales. 

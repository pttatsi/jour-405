...
### Task 4: Calculate the mean and median fees for Fall 2024 using `summarize()`
...
umd_fees |> 
    summarize(mean_2024_fees = mean(fall_2024),
            ...
            mean_2021_fees = mean(fall_2021)
)


```

### Task 5: Add to the previous the max and minimum values for 2024 in addition to the mean and median fees for Fall 2024 using `summarize()`
...
The University is investing more in shuttle buses as they get stricter about scooter access on campus. 

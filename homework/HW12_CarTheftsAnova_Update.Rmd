...
**WRITE YOUR ANSWER HERE**: The median rate nearly tripled from the 22.2 in the pre-spike to 58.1 in the spike year but the sample sizes varied a great deal, with 71 observations in pre-spike versus 12 in the spike year. The numbers suggest that it wasn't the number of crimes increasing but the rate at which they happened relative to the population. 
...
**WRITE YOUR ANSWER HERE** The output visualizes the monthly rate of theft in PG county over a 9-year period with a significant spike in 2023. 

**Title: Monthly car theft rates increases per 100,000 PG county residents across nine years with significant spike in 2023
...
- **Null Hypothesis (H0)**:   There will be no difference in theft rate between the three time periods 
- **Alternative Hypothesis (H1)**: There will be a difference in theft rate between the three time periods 
...
**WRITE YOUR ANSWER HERE** The ANOVA results show real and statistically significant differences in the average rates across the three time periods. The F-statistic is very large (F = 218), and the p-value is effectively zero (p < 2e-16), which is indicated by the *** significance code. This means the differences in mean rates between the pre-spike, spike year, and post-spike periods are far too large to be explained by random variation. So the spike year genuinely had higher car theft rates than the pre-spike period, and the post-spike period also remained relatively elevated to pre-spike levels.
...
The Tukey test tells us where the significance comes from. From this test, we can see the most significant difference comes from the comparison of pre-spike and spike years. The difference between the pre-spike and post-spike years are real and significant, as indicated by the -20.13231 difference. The p-value is  zero for all categories/comparisons which confirms that this increase was not due to random chance. So, even after the spike year ended, theft rates remained significantly higher than they were before the spike.

HL: New data shows car thefts significantly rose in PG county since 2023 
LEDE: Car thefts in Prince George’s County spiked dramatically in 2023 and have remained above pre-spike levels ever since, according to new analysis of car thefts in the county over a nine year period.

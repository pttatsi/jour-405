...
**WRITE ANSWERS HERE:**  My initial reaction is that car thefts have steadily decreased since 2023, with significant drop sometime in 2024, though there are some periods of little upcline sometime between 2024 and 2025.  
...
Let's make a better chart showing the changes and the statistics we produced in Task 4. Does this change anything about your answer from Task 3?  Not necessarily, I still feel that crime has generally decreased from the time period where our analysis starts and ends, though there are notable outliers. 
...
** We’re 95% confident that the true mean number of thefts per month is between about 415 and 506.

- What figure(s) accurately reflects the number of car thefts in a typical month? **WRITE ANSWER HERE:** 
** In a typical month, there are about 460 car thefts, usually between 415 and 506.
...
**WRITE ANSWER HERE:** Car thefts in PG county significantly decreased since 2023 despite seasonal outliers 
...
Given the above chart, is the difference between the two periods statistically significant? Can we reject the null hypothesis? **WRITE ANSWER HERE:** The p-value of 0.17 is larger than 0.05 which is our level of significance. So we reject the null hypothesis that the difference between the two periods is statistically significany
...
I don't know what yet i'd change my headline to say but I would tell my editor that I want to investigate outliers and see if there are common causes. It also seems like the data set is incomplete, we don't have all of 2023 and most of 2025 so I would try to find that information and redo the test. The results of that will help me know how to change my headline. 

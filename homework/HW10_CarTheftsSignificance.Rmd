...
**WRITE ANSWER HERE:** Car thefts significantly went down since 2023 despite seasonal outliers 
...
period_summary <- car_thefts |> 
  ...
  summarize(
    ...
    months = n(),
    se_thefts = sd_thefts / sqrt(months),
    margin_error = qt(0.975, df = month - 1) * se_thefts, # look at how we calculated this above
    ci_lower = mean_thefts - margin_error,
    ci_upper = mean_thefts + margin_error
  )

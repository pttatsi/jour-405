...
**Write your answers here:** No the headline is not statistically justified for the first and second scenario because the margin of error takes the percentages below majority population. An alternate headline could be "Almost half the population voted in support for New City Policy"
...
t_test_result <- t.test(
  home_data$sale_price, #data frame and column name 
  mu = prior_mean, 
  alternative = "greater"
)
...
** Based on data collected from recent home sales, there is strong evidence that the development of transit lines increased home values. Prior to the transit line, an average home cost $285,000 but raised to $304,500. One possible reason for raised prices would be accessibility to the metro. Accessibility increases demand and the market responded by raising the price by 6.8%. 
